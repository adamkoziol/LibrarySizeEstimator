...
# Only include insert sizes smaller than 1000. One issue I noticed was that sometimes reads are mapped in such a way that
...
# Create a plot of data from c (0 < insertSizes < 1000)
